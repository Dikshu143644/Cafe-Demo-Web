...
import { CreditCard, MapPin, Check, Sparkles, ShoppingBag, ArrowLeft, ShieldCheck, AlertCircle, RefreshCw, X } from 'lucide-react';
    ...
    return (
      <div id="checkout-success-view" className="bg-transparent min-h-screen pt-32 pb-24 font-sans text-cafe-smoky relative z-10 flex items-center justify-center animate-fadeIn">
        <div className="max-w-lg w-full mx-auto px-4">
          <GlassCard theme="light" className="text-center p-8 bg-white/90 space-y-6 relative" hoverEffect={false}>
            <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-[#D4AF37] to-emerald-500 rounded-t-2xl" />

            <div className="w-16 h-16 rounded-full bg-emerald-100 border border-emerald-400/20 text-emerald-600 flex items-center justify-center mx-auto shadow-md animate-pulse">
